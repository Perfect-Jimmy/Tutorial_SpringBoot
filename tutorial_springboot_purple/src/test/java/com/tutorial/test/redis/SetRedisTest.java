...
public class SetRedisTest {
    ...
    public void intersectTest(){
        ...
        jsonRedisTemplate.opsForSet().add("intersect_set_1",array1);
        jsonRedisTemplate.opsForSet().add("intersect_set_2",array2);
        jsonRedisTemplate.opsForSet().add("intersect_set_3",array3);
        Set<String> set = jsonRedisTemplate.opsForSet().intersect("intersect_set_1","intersect_set_2");
        System.out.println(set);//[set3, set2, set1]
        List<String> list = Lists.newArrayList();
        list.add("intersect_set_2");
        list.add("intersect_set_3");
        Set<String> setMuti = jsonRedisTemplate.opsForSet().intersect("intersect_set_1",list);
    ...
    public void intersectAndStore(){
        ...
        String[] array2 = StringUtils.delimitedListToStringArray("set1,set2,set3,set4",",");
        String[] array3 = StringUtils.delimitedListToStringArray("set0,set1,set2,set5",",");
        jsonRedisTemplate.opsForSet().add("intersect_store_set_1",array1);
        jsonRedisTemplate.opsForSet().add("intersect_store_set_2",array2);
        jsonRedisTemplate.opsForSet().add("intersect_store_set_3",array3);

        jsonRedisTemplate.opsForSet().intersectAndStore("intersect_store_set_1","intersect_store_set_2","intersect_store_set_dest");

        System.out.println(jsonRedisTemplate.opsForSet().members("intersect_store_set_dest"));
        //[set2, set3, set1]
        List<String> list = Lists.newArrayList();
        list.add("intersect_store_set_1");
        list.add("intersect_store_set_2");
        jsonRedisTemplate.opsForSet().intersectAndStore("intersect_store_set_3",list,"intersect_store_set_destMuti");
        System.out.println(jsonRedisTemplate.opsForSet().members("intersect_store_set_destMuti"));
        //[set2, set1]
    }
    ...
    public void unionTest(){
         ...
         jsonRedisTemplate.opsForSet().add("union_set_1",array1);
         jsonRedisTemplate.opsForSet().add("union_set_2",array2);
         jsonRedisTemplate.opsForSet().add("union_set_3",array3);
         System.out.println( jsonRedisTemplate.opsForSet().union("union_set_1","union_set_2"));
         //[set3, set5, set4, set1, set2]
         List<String> list = Lists.newArrayList();
         list.add("union_set_1");
         list.add("union_set_2");
         System.out.println( jsonRedisTemplate.opsForSet().union("union_set_3",list));
         //[set3, set5, set1, set7, set6, set4, set2, set8]
         //------------------并集存储-----------------------------------------------------------------
         jsonRedisTemplate.opsForSet().add("union_store_set_1",array1);
         jsonRedisTemplate.opsForSet().add("union_store_set_2",array2);
         jsonRedisTemplate.opsForSet().add("union_store_set_3",array3);
         System.out.println( jsonRedisTemplate.opsForSet().unionAndStore("union_store_set_1","union_store_set_2","union_store_set_dest"));
    }
    ...
    public void differenceTest(){
        ...
        String[] array2 = StringUtils.delimitedListToStringArray("set1,set2,set4,set5",",");
        String[] array3 = StringUtils.delimitedListToStringArray("set4,set6,set7,set8",",");
        jsonRedisTemplate.opsForSet().add("difference_set_1",array1);
        jsonRedisTemplate.opsForSet().add("difference_set_2",array2);
        jsonRedisTemplate.opsForSet().add("difference_set_3",array3);
        System.out.println( jsonRedisTemplate.opsForSet().difference("difference_set_1","difference_set_2"));
        List<String> list = Lists.newArrayList();
        list.add("difference_set_1");
        list.add("difference_set_2");
        System.out.println( jsonRedisTemplate.opsForSet().difference("difference_set_1",list));
    }
    ...
    public void randomMemberTest(){
        ...
        jsonRedisTemplate.opsForSet().add("random_set",array);
        System.out.println(jsonRedisTemplate.opsForSet().randomMember("random_set"));
        System.out.println(jsonRedisTemplate.opsForSet().randomMembers("random_set",4));//[set5, set5, set3, set3]
        System.out.println(jsonRedisTemplate.opsForSet().distinctRandomMembers("random_set",11));//[set4, set1, set3, set2, set5, set6]
    }
    ...
    public void scanTest(){
        String[] array = StringUtils.delimitedListToStringArray("set1,set2,set3,set4,set2,set3,set5,set3,set6",",");
        jsonRedisTemplate.opsForSet().add("scan_set1",array);
        Cursor<Object> curosr = jsonRedisTemplate.opsForSet().scan("scan_set1", ScanOptions.NONE);
